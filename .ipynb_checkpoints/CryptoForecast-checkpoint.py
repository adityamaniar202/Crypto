# -*- coding: utf-8 -*-
"""ETH forecasting.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QiAM3D6apx_eyO_JdBCngxN8jNuoYqaW
"""
...
res = requests.get(endpoint + '?fsym='+crypto+'&tsym='+fiat+'&limit='+str(limit))#'&api_key='+api_key)
...
model = build_lstm_model(
    X_train, output_size=1, neurons=lstm_neurons,activ_func='linear', dropout=dropout, loss=loss,
    optimizer=optimizer)
history = model.fit(
...
ch=input("Do you want to save the model? (Y/N)")
if(ch=='Y'):
    save_model()
